...
project root/  
    amazon-risk.ipynb          Main Jupyter notebook  
...
Notes  
This project was completed for DS 5030 (Project 1).  
All analysis was conducted in Python using open-source libraries.
